...
public class Manufacturer extends Agent{
		...
		public void action() {
			...
			if (msg != null) { 
				...
				if (msg.getContent().equals("new day")) {
					...
					//Spacing to clearly separate the final result from the final day.
					System.out.println("");
	...
	public class NewDay extends OneShotBehaviour {
		...
		public void action() {	
			...
			//Spacing to clearly separate each simulated day in the console.
			System.out.println("");
		...
		public void action() {
			...
			while (todaysOrder.getCustomer() != null && canBuildToday != 0){
				...
				if(ordersRemainingPhones == 0) {
					...
					//	to end early is it has not yet hit 50 phones built today.
