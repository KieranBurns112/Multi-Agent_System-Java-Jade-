...
public class PartTypes {
	...
	private String[] screens = new String[] {"5\"", "7\""};
	private String[] batteries = new String[] {"2000mAh", "3000mAh"};
	private String[] RAM = new String[] {"8Gb", "64Gb"};
	private String[] storages= new String[] {"64Gb", "256Gb"};
